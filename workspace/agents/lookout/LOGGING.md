...
- Completed work (rank reports, anomaly alerts)
- Client patterns (seasonal trends, recurring drops)
- Learnings (what signals matter, false positives)
- Blockers encountered

## When to Log
- **After every task completion** (before sending deliverable to Archer/Cody)
- **After discovering a pattern** (e.g., "Client X drops every Monday — server maintenance")
- **After a blocker** (e.g., "GSC API access missing for client Y")
...
**Seasonal Trends:**
- {Trend pattern — e.g., "Rankings drop 10% every December (holiday closures)"}
...
**This is mandatory. Tracking patterns is your job.**
