# LocalCatalyst - Blog Post: Internal Linking Strategy: The Most Underused Lever in On-Page SEO
...
A single well-placed internal link from your highest-authority page to an underperforming service page can produce a measurable ranking lift within weeks. We see this consistently across the local business sites we optimize through our [on-page optimization service](/services/on-page-optimization/).
...
1. **Screaming Frog** — Crawl your site and filter for pages with zero inlinks. Cross-reference with your sitemap to find pages that exist but receive no internal links.
2. **Ahrefs Site Audit** — The "Orphan pages" report identifies indexed URLs with no internal links detected during the crawl.
3. **Google Search Console** — Review the Pages report for indexed pages, then check if those URLs appear in your Screaming Frog inlink data.
