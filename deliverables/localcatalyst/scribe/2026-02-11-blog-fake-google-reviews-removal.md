# LocalCatalyst - How to Remove Fake Google Reviews
...
**Meta Description:** Learn the step-by-step process to identify, report, and remove fake Google reviews. Protect your business reputation from fraudulent and malicious reviews.
**H1:** How to Remove Fake Google Reviews: The Complete Process
...
**Process:**
1. Open Google Maps and navigate to your business listing
...
5. Choose the reason that best matches the violation (spam, fake content, off-topic, conflict of interest)
6. Submit the report
...
**Process:**
1. Go to Google's "Manage your reviews" support page
2. Sign in with the Google account that manages your Business Profile
3. Select the business location
4. Find and select the review you want to report
5. Provide detailed reasoning for why the review violates Google's policies
6. Submit the report
