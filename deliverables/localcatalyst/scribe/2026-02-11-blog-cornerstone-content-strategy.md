# LocalCatalyst - Blog Post: Cornerstone Content Strategy
...
**Meta Description:** Learn how to identify, create, and optimize cornerstone content that anchors your site's authority. Internal linking, maintenance, and prioritization covered.
**H1:** Cornerstone Content Strategy: How to Build the Foundation of Your Site's Authority
...
| Aspect | Cornerstone Content | Regular Content |
|--------|-------------------|-----------------|
| Scope | Broad, comprehensive | Focused, specific |
| Length | Typically 2,000-5,000+ words | Varies, often 800-2,000 words |
...
1. List all content that falls within each cornerstone's topic cluster
2. Review each piece for opportunities to add a contextual link to the cornerstone
3. Ensure the cornerstone links out to every relevant supporting piece
4. Identify supporting pieces that should cross-link to each other
5. Document the linking structure so it can be maintained as new content is published
