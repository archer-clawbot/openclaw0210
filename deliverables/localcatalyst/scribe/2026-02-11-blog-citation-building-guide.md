# LocalCatalyst - Blog Post: The Complete Citation Building Guide for Local Businesses
...
Our [on-page optimization service](/services/on-page-optimization/) includes NAP schema markup implementation, which reinforces your canonical NAP data directly in your site's structured data.
...
3. **Build Tier 1 and Tier 2 citations** (Week 4-6)
4. **Build industry-specific and geo-specific citations** (Week 6-10)
5. **Monitor and maintain quarterly** (Ongoing)
